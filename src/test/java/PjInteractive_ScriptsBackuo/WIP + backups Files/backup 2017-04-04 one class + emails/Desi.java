...
public class Desi {
    ...
    public void DesiTest() throws Exception {
        ...
        //Set log path
        String logPath = "/C:/Users/catalinf/Google Drive/IntelliJ Scripts/DesiLaColScripts/Logs/";
        //Set Log output file
        ...
        String filename = logPath + "Console Logs " + dateFormatted2 + ".txt";
        //Set Filepath 2 for Email logs attachment
        String filename2 = logPath + "Desi-logs.txt";
        //Chrome driver path
                    ...
                    for (paymentloop = paymentloops; paymentloop < 5; paymentloop++) {
                        ...
                        for (prodloop = prodloops; prodloop < 10; prodloop++) {
                            ...
                            try {
                                ...
                                Emails.E1(e1, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                            ...
                            try {
                                ...
                                Emails.E2(e2, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                        ...
                        */
                            ...
                            try {
                                ...
                                Emails.E3(e3, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                            ...
                            if (driver.findElement(By.xpath(xabb)).isEnabled()) {
                                ...
                                try {
                                    ...
                                    Emails.E4(e4, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E5(e5, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E6(e6, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E7(e7, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E8(e8, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E9(e9, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                                ...
                                try {
                                    ...
                                    Emails.E10(e10, session, username, gto, gcc, dateFormatted, dateFormatted2, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, ssPath, driver);
                        ...
                        if (skipEmail != 1) {
                            ...
                            Emails.FinalMail(session, username, gto, gcc, dateFormatted, productNames, countryidi, countrys, drvName, drvIDi, site, country, filename, filename2, paymenti, paymentloop, paymentName, orderReferences, CC, CVC);
