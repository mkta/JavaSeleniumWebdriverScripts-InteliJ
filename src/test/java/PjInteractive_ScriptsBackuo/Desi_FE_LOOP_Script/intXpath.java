...
class intXpath extends DesiFELOOPTest {
...
/////////////////////////// Note: country, payment and product selector xpath are set at the beginning of their loops ///////////////////////////
    ...
    //Xpath for navigation listing ( Women )
    static final String xnavListing = "html/body/section[2]/header/nav/div[2]/ul/li[1]/a/span";
    ...
    //Xpath for PLP breadcrumbs
    static final String xbcListing = "html/body/section[3]/router-view/div/section[2]/div/ul/li[2]/a";
